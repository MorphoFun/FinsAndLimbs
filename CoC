...
Lab members and guests are welcome to contribute to our shared folder in a variety of ways, including (but not excluded to):
Depositing new papers or digital literature to our FinsAndLimbsPapers folder, using a similar convention to name the files
Commenting or suggesting edits to shared documents, such as SOPs, tutorials, animal care documents, etc. 
Adding new resources that may be of interest to others
Proposing new documents or resources that do not currently exist in the folder


Improper Use
Some of the materials contained within this folder are the intellectual property of the PI and may not be shared without written permission from the PI. If you would like to share or distribute any of the materials outside of this lab, please email the PI ahead of time. Some examples of improper use of this folder include (but are not excluded to): 
Inviting people to the shared folder without the PI’s permission
Sharing tutorials, SOPs, and other documents to members out of the lab without the PI’s permission
Editing, deleting, or defacing any of the digital copies of the papers
